...
3.LLOYD, Stuart P. Least Squares Quantization in PCM. IEEE Transactions on Information Theory, v. 28, n. 2, p. 129–137, 1982.

Artigo original que define o algoritmo K-Means, utilizado na etapa de agrupamento de entregas.

4.UPS. ORION: On-Road Integrated Optimization and Navigation. UPS Pressroom, 2024.
...
6.RIBEIRO, Marco Túlio; SINGH, Sameer; GUESTRIN, Carlos. "Why Should I Trust You?": Explaining the Predictions of Any Classifier. Proceedings of the 22nd ACM SIGKDD International Conference on Knowledge Discovery and Data Mining, 2016.
...
7.OPENAI. Research Portal. Disponível em: https://openai.com/research
. Acesso em: nov. 2025.
Fonte complementar sobre avanços contemporâneos em Inteligência Artificial e aplicações práticas.

8.IBM. K-Means Clustering in Logistics Optimization. IBM Developer Portal, 2024. Disponível em: https://developer.ibm.com/
.
